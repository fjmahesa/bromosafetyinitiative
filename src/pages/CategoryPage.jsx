...
function CategoryPage() {
  ...
  if (isLoading) {
    return (
      <div className="max-w-7xl mx-auto w-full px-4 py-20 animate-pulse space-y-8">
  ...
  return (
    <div className="max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-12 md:py-20 min-h-screen">
      ...
      {articles.length === 0 ? (
        <div className="text-center py-20 text-slate-400 font-bold">Belum ada artikel di kategori ini.</div>
      ) : (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {articles.map((post) => {
