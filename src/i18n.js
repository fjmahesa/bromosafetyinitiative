...
const resources = {
  en: {
    translation: {
      ...
      o2oOnlinePointDesc3: "Creating educational content related to riding safety and Bromo route conditions.",
      ...
      aboutDescMain: "A multi-stakeholder initiative to create a safe, comfortable, and responsible Mount Bromo tourism ecosystem.",
      aboutParagraph1: "Bromo Safety Initiative (BSI) is a collaborative movement born out of concern for the safety of tourists, local communities, and all tourism actors in the Mount Bromo region.",
      aboutParagraph2: "Stemming from the high volume of tourism activities in Bromo—characterized by mountainous terrain with extreme inclines and steep declines—BSI strives to build a safety culture through education, public campaigns, provisioning safety infrastructure, and strengthening cooperation between the government, communities, businesses, and various other stakeholders.",
      aboutRestAreaTitle: "Bromo Safety Initiative Rest Area",
      aboutRestAreaDesc: "One concrete manifestation of this movement is the construction of the Bromo Safety Initiative Rest Area as a rest stop and safety education point for tourists riding automatic motorbikes before and after entering the Bromo tourism area.",
      aboutParagraph3: "BSI firmly believes that safety is not just the responsibility of a single party, but a collective duty to preserve Bromo as a world-class destination that is safe, welcoming, and sustainable for present and future generations.",
      aboutVisionBadge: "Core Vision",
      aboutVisionTitle: "Vision",
      aboutVisionDesc: "\"To be the leading collaborative movement in realizing a safe, comfortable, sustainable, and competitive Bromo destination through safety culture and community empowerment.\"",
      ...
      aboutMission1: "To raise safety awareness and culture among tourists, local communities, and tourism operators in the Bromo area.",
      ...
      aboutMission6: "To support environmental conservation and preserve the Bromo destination as a highly-valued natural and cultural heritage site.",
      ...
      aboutSlogan: "\"Preserving Bromo Together, Prioritizing Safety Together.\"",
      ...
      aboutValueSustDesc: "Preserving the Bromo region ecosystem for generations to come.",
  ...
  id: {
    translation: {
      ...
      aboutDescMain: "Inisiatif multipihak untuk mewujudkan ekosistem pariwisata Gunung Bromo yang aman, nyaman, dan bertanggung jawab.",
      aboutParagraph1: "Bromo Safety Initiative (BSI) adalah gerakan kolaboratif yang lahir dari kepedulian terhadap keselamatan wisatawan, masyarakat, dan seluruh pelaku wisata di kawasan Gunung Bromo.",
